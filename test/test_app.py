...
class CreateTests(unittest.TestCase):
    def test_runs_setup_in_prod_mode(self, env, queue_class, datacontext,
                                     webapi, create_scheduld, reloader,
                                     exit_register):
        ...
        create_scheduld.assert_called_with(queue_class.return_value,
                                           datacontext.load.return_value)
        webapi.setup.assert_called_with(webapi.create.return_value,
    ...
    def test_runs_setup_in_reloader(self, env, queue_class, datacontext,
                                    webapi, create_scheduld, reloader,
                                    exit_register):
    ...
    def test_skips_setup_if_debug_and_not_reloader(self, env, queue_class,
                                                   datacontext, webapi,
                                                   create_scheduld, reloader,
                                                   exit_register):
        reloader.return_value = False
        webapi.create.return_value.debug = True
    ...
    def test_logs_exceptions(self, fake_log, env, queue_class, datacontext,
