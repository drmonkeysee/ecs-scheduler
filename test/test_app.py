...
class CreateTests(unittest.TestCase):
    def test_starts_daemon_in_prod_mode(self, startup, queue_class, datacontext, create_webapi, create_scheduld, reloader, exit_register):
    ...
    def test_starts_daemon_in_reloader(self, startup, queue_class, datacontext, create_webapi, create_scheduld, reloader, exit_register):
    ...
    def test_skips_daemon_if_debug_and_not_reloader(self, startup, queue_class, datacontext, create_webapi, create_scheduld, reloader, exit_register):
        reloader.return_value = False
        create_webapi.return_value.debug = True
    ...
    def test_startup_logs_exceptions(self, fake_log, startup, queue_class, datacontext, create_webapi, create_scheduld, reloader, exit_register):
