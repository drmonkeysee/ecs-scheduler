...
class SchedulerTests(unittest.TestCase):
    ...
    def test_add_job_creates_new_job(self):
        job = Mock(id='job4', parsed_schedule={'day': '23'},
    ...
    @patch.object(logging.getLogger('ecs_scheduler.scheduld.scheduler'),
                  'exception')
...
class ScheduleEventHandlerTests(unittest.TestCase):
    ...
    @patch.object(logging.getLogger('ecs_scheduler.scheduld.scheduler'),
                  'warning')
    def test_checked_tasks_logs_warning_if_scheduled_job_not_found(self,
                                                                   fake_log):
        event = apscheduler.events.JobExecutionEvent(
            apscheduler.events.EVENT_JOB_EXECUTED,
            'test_id',
    ...
    @patch.object(logging.getLogger('ecs_scheduler.scheduld.scheduler'),
                  'warning')
    def test_checked_tasks_logs_warning_if_stored_job_not_found(self,
                                                                fake_log):
        event = apscheduler.events.JobExecutionEvent(
            apscheduler.events.EVENT_JOB_EXECUTED,
            'test_id',
    ...
    @patch.object(logging.getLogger('ecs_scheduler.scheduld.scheduler'),
                  'warning')
    def test_started_tasks_logs_warning_if_scheduled_job_not_found(self,
                                                                   fake_log):
        expected_last_run_time = datetime.datetime(2013, 11, 11)
        event = apscheduler.events.JobExecutionEvent(
            apscheduler.events.EVENT_JOB_EXECUTED,
    ...
    @patch.object(logging.getLogger('ecs_scheduler.scheduld.scheduler'),
                  'warning')
    def test_started_tasks_logs_warning_if_stored_job_not_found(self,
                                                                fake_log):
        expected_last_run_time = datetime.datetime(2013, 11, 11)
        event = apscheduler.events.JobExecutionEvent(
            apscheduler.events.EVENT_JOB_EXECUTED,
    ...
    @patch.object(logging.getLogger('ecs_scheduler.scheduld.scheduler'),
                  'warning')
    def test_modify_job_logs_warning_if_scheduled_job_not_found(self,
                                                                fake_log):
        event = apscheduler.events.JobExecutionEvent(
            apscheduler.events.EVENT_JOB_MODIFIED,
            'test_id',
