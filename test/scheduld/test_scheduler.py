...
class SchedulerTests(unittest.TestCase):
    ...
    def test_start(self):
        self._dc.get_all.return_value = (Mock(id='job1', parsed_schedule={'second': '10'}),
    ...
    def test_add_job_creates_new_job(self):
        job = Mock(id='job4', parsed_schedule={'day': '23'}, suspended=False, data={})
    ...
    def test_add_job_creates_new_job_as_paused_if_suspended(self):
        job = Mock(id='job4', parsed_schedule={'day': '23'}, suspended=True, data={})
        self._dc.get.return_value = job
    ...
    def test_add_job_sets_end_date_if_given(self):
        ...
        job = Mock(id='job4', parsed_schedule={'day': '23'}, suspended=False, data={'scheduleEnd': test_date})
        self._dc.get.return_value = job
    ...
    def test_add_job_sets_start_date_if_given(self):
        test_date = datetime.datetime.now()
        job = Mock(id='job4', parsed_schedule={'day': '23'}, suspended=False, data={'scheduleStart': test_date})
        self._dc.get.return_value = job
    ...
    def test_add_job_sets_start_date_as_last_run_if_given(self):
        ...
        job = Mock(id='job4', parsed_schedule={'day': '23'}, suspended=False, data={'scheduleStart': schedule_start, 'lastRun': last_run})
        self._dc.get.return_value = job
...
class ScheduleEventHandlerTests(unittest.TestCase):
    ...
    def test_checked_tasks_updates_estimated_next_run(self):
        ...
        stored_job.annotate.assert_called_with({'estimatedNextRun': test_scheduled_job.next_run_time})
    ...
    def test_started_tasks_updates_dates(self):
        ...
        stored_job.annotate.assert_called_with({'estimatedNextRun': test_scheduled_job.next_run_time, 'lastRun': expected_last_run_time, 'lastRunTasks': ['foo', 'bar']})
    ...
    def test_started_tasks_omits_next_run_if_none(self):
        ...
        stored_job.annotate.assert_called_with({'lastRun': expected_last_run_time, 'lastRunTasks': ['foo', 'bar']})
