...
class MainTests(unittest.TestCase):
    def test_run_webapi(self, fake_init, fake_queue_class, fake_server_run, fake_app_run):
    ...
    def test_run_scheduld(self, fake_init, fake_queue_class, fake_server_run, fake_app_run):
